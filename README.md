# demo_catalog
Proyecto ejemplo para la utilización de Huemul BigDataGovernance version 2.5
...
* **huemul_drivers.zip:** Drivers utilizados por Huemul, contiene lo siguiente:
   * huemul-bigdatagovernance-2.5.jar: Framework Huemul BigData 
...
www.huemulsolutions.com/ /ejemplos/sbif_23/demo-sbif.zip
www.huemulsolutions.com/ /ejemplos/sbif_23/huemul_install_sbif.sh
...
```shell
spark-submit --master local --jars huemul-bigdatagovernance-2.5.jar,huemul-sql-decode-1.0.jar,demo_settings-2.5.jar,demo_catalogo-2.5.jar,postgresql-9.4.1212.jar --class com.yourcompany.catalogo.process_negocio  demo_sbif-2.5.jar environment=production,ano=2018,mes=6
```
...
```shell
spark-submit --master local --jars huemul-bigdatagovernance-2.5.jar,huemul-sql-decode-1.0.jar,demo_settings-2.5.jar,demo_catalogo-2.5.jar,postgresql-9.4.1212.jar --class com.yourcompany.catalogo.process_producto  demo_sbif-2.5.jar environment=production,ano=2018,mes=6
```