...
object process_producto {
  ...
  */
  def main(args : Array[String]) {
    //Creacion API
    val huemulBigDataGov  = new huemul_BigDataGovernance(s"Masterizacion tabla tbl_comun_producto_mes - ${this.getClass.getSimpleName}", args, globalSettings.Global)
  ...
  def process_master(huemulBigDataGov: huemul_BigDataGovernance, ControlParent: huemul_Control, param_ano: Integer, param_mes: Integer): Boolean = {
    ...
    try {             
      ...
      /*************** LOGICAS DE NEGOCIO **********************/
      /*********************************************************/
      //instancia de clase tbl_comun_producto_mes 
      val huemulTable = new tbl_comun_producto(huemulBigDataGov, Control)
...
*/
object process_producto_Migrar {
 
 def main(args : Array[String]) {
   //Creacion API
    val huemulBigDataGov  = new huemul_BigDataGovernance(s"Migración de datos tabla tbl_comun_producto_mes  - ${this.getClass.getSimpleName}", args, globalSettings.Global)
   ...
   val clase = new tbl_comun_producto(huemulBigDataGov, null)
