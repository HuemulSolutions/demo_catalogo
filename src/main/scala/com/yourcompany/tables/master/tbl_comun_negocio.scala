...
class tbl_comun_negocio(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_Table(huemulBigDataGov, Control) with Serializable {
  ...
  //this.WhoCanRun_executeFull_addAccess("process_negocio", "com.yourcompany.catalogo")
  ...
  //negocio_id.setDQ_MinLen(5) 
  //negocio_id.setDQ_MaxLen(100)  

  val negocio_nombre = new huemul_Columns (StringType, true, "Nombre del negocio (Consumo, Hipotecario,etc)") 
  negocio_nombre.setARCO_Data(false)  
  negocio_nombre.setSecurityLevel(huemulType_SecurityLevel.Public)  
  negocio_nombre.setMDM_EnableOldValue(true)  
  negocio_nombre.setMDM_EnableDTLog(true)  
  negocio_nombre.setMDM_EnableProcessLog(true)  
  //negocio_nombre.setDQ_MinLen(5) 
  //negocio_nombre.setDQ_MaxLen(100)  
